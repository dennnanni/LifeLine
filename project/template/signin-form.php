    ...
    <div class="row justify-content-center mb-4">
        <div class="col-xl-5 col-md-6 col-10">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item col-4 col-xl-5">
                    <a class="nav-link text-tertiary btn-lg fw-bold" id="signup" href="signup.php">Sign up</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <form class="col-xl-5 col-md-6 col-10" action="#" method="POST" id="signinForm">
            <ul class="list-unstyled">
                <li>
                    ...
                    <input class="w-100 mb-1 rounded-3 border-1 border-tertiary-light border-solid border btn-lg" type="text" id="email" name="email" placeholder="Email" required/>
                </li>
                <li>
                    <label for="password" hidden>Password</label>
                    <input class="w-100 mb-1 rounded-3 border-1 border-tertiary-light border-solid border btn-lg" type="password" id="password" name="password" placeholder="Password" required/>
                </li>
                <li>
