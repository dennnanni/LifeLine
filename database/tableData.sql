...
INSERT INTO NOTIFICATION (datetime, text, read_status, username) VALUES
('2024-01-01 12:20:00', 'user2 liked your post.', 'N', 'user1'),
('2024-01-01 12:35:00', 'user3 liked your post.', 'N', 'user1'),
('2024-01-03 17:15:00', 'user1 liked your post.', 'N', 'user3'),
('2024-01-04 10:45:00', 'user2 liked your post.', 'N', 'user3'),
('2024-01-05 19:00:00', 'user3 liked your post.', 'N', 'user2'),
('2024-01-07 10:15:00', 'user1 liked your post.', 'N', 'user3');

-- Notifiche per commenti
INSERT INTO NOTIFICATION (datetime, text, read_status, username) VALUES
('2024-01-01 12:40:00', 'user2 commented on your post.', 'N', 'user1'),
('2024-01-01 12:50:00', 'user3 commented on your post.', 'N', 'user1'),
('2024-01-03 17:30:00', 'user1 commented on your post.', 'N', 'user3'),
