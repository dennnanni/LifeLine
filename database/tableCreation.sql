...
CREATE TABLE IF NOT EXISTS POST (
    ...
    CONSTRAINT REF_POST_USER_FK FOREIGN KEY (author) REFERENCES USER(username)
);
...
CREATE TABLE IF NOT EXISTS NOTIFICATION (
    ...
    CONSTRAINT REF_NOTIF_SENDER_FK FOREIGN KEY (sender) REFERENCES USER(username),
    CONSTRAINT REF_NOTIF_RECEIVER_FK FOREIGN KEY (receiver) REFERENCES USER(username),
    CONSTRAINT REF_NOTIF_POST_FK FOREIGN KEY (postId) REFERENCES POST(id)
);
